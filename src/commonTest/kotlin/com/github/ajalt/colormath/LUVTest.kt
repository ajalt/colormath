...
class LUVTest {
    ...
    fun `LUV to HCL`() = forAll(
        row(LUV(000.0, 000.0, 000.0), HCL(0.0, 0.0, 0.0)),
        row(LUV(000.0, 100.0, 100.0), HCL(0.0, 0.0, 0.0)),
        row(LUV(000.0, 000.0, 100.0), HCL(0.0, 0.0, 0.0)),
        row(LUV(000.0, 100.0, 000.0), HCL(0.0, 0.0, 0.0)),
        row(LUV(100.0, 000.0, 000.0), HCL(0.0, 0.0, 100.0)),
