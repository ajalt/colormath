...
class ICtCpTest {
    ...
    fun `ICtCp to BT2020`() = testColorConversions(
        ...
        ICtCp(0.08, 0.00, 0.00) to BT_2020(0.41300407, 0.41300407, 0.41300407),
        ICtCp(0.10, 0.01, -0.01) to BT_2020(0.51900627, 0.57112792, 0.64131823),
        ICtCp(0.15, 0.00, 0.00) to BT_2020(1.00052666, 1.00052666, 1.00052666),
    )
