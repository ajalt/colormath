...
dependencies {
    ...
    implementation("com.github.ajalt.colormath:colormath-ext-android-color:3.7.0")
    // androidx.annotation.ColorInt
    implementation("com.github.ajalt.colormath:colormath-ext-android-colorint:3.7.0")
    // androidx.compose.ui.graphics.Color
    implementation("com.github.ajalt.colormath:colormath-ext-jetpack-compose:3.7.0")
}
```
